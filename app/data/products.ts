...
export const products: Product[] = [
  ...
  // Rings (Cincin)
  {
    ...
    description:
      "Cincin bertema lotus mekar — simbol kekuatan lembut, pertumbuhan batin, dan kecantikan yang matang. Desain kelopaknya yang detail memancarkan keanggunan dari setiap sudut.",
    material: "Silver 925 dengan lapisan 18K Gold Plated",
    weight: "——— gram",
    dimensions: "———",
    features: [
      "Detail kelopak yang presisi",
      "Silver 925 + 18K Gold Plated",
    ...
    story:
      "Blooming Lotus Ring Gold dirancang untuk menangkap keindahan lotus yang mekar pelan — sebagai simbol perjalanan batin yang stabil dan penuh penerimaan. Lotus mengajarkan bahwa pertumbuhan sejati tidak tergesa. Ia berkembang sesuai ritmenya sendiri, dan tetap indah di segala musim.\n\n✨ Pengalaman yang Dirasakan Pemakai\n• Memberikan rasa percaya diri yang lembut\n• Membuat tampilan tangan lebih elegan\n• Menjadi anchor emosional saat hari terasa berat\n• Memberikan kesan dewasa namun feminin\n\nMengapa Memilih Blooming Lotus Ring Gold\nJika Anda menyukai keanggunan lembut dan makna pertumbuhan, cincin ini menjadi pilihan sempurna. Ia menghadirkan kilau hangat yang memancarkan ketenangan dan pencerahan.\n\nPerawatan & Garansi\nTermasuk 1x cleaning atau replating, berlaku 1 tahun, (dengan kartu perawatan valid).",
  },
  {
    id: 19,
  ...
  {
    id: 20,
    name: "Danayu Ring Gold",
    price: "Hubungi Kami",
    priceNumber: 0,
    category: "Cincin",
    image: "/Danayu Ring Gold/HAL06738 copy.jpg",
    images: [
    ...
    description:
      "Cincin emas koleksi Danayu yang eksklusif, memancarkan kemewahan dalam setiap detail.",
    material: "Emas",
    weight: "-",
    dimensions: "Ring size custom",
    features: [
      "Desain eksklusif Danayu",
    ...
    story:
      "Koleksi Danayu Ring menghadirkan kemewahan yang tidak terbantahkan, dirancang untuk momen-momen terpenting dalam hidup.",
  },
  {
    id: 21,
    name: "Hanging Pucuk Ring Gold",
    price: "Hubungi Kami",
    priceNumber: 0,
    category: "Cincin",
    image: "/Hanging Pucuk Ring Gold/HAL06664 copy1.jpg",
    images: [
      "/Hanging Pucuk Ring Gold/HAL_DAHAYU_10119.jpg",
      "/Hanging Pucuk Ring Gold/HAL06664 copy1.jpg",
      "/Hanging Pucuk Ring Gold/HAL06881 copy.jpg",
    ],
    description:
      "Cincin emas dengan desain pucuk gantung yang unik dan modern.",
    material: "Emas",
    weight: "-",
    dimensions: "Ring size custom",
    features: [
      "Desain pucuk gantung yang unik",
      "Emas premium",
      "Gerakan dinamis yang indah",
      "Cocok untuk acara formal",
      "Desain yang eye-catching",
    ],
    story:
      "Pucuk gantung melambangkan pertumbuhan yang dinamis. Cincin ini sempurna untuk mereka yang berani tampil beda.",
  },
  {
    id: 22,
    name: "Hanging Pucuk Ring Silver",
    price: "Hubungi Kami",
    priceNumber: 0,
    category: "Cincin",
    image: "/Hanging Pucuk Ring Silver/pucuk-gantung-silver-1-768x768.png",
    images: ["/Hanging Pucuk Ring Silver/1.png"],
    description:
      "Cincin perak dengan desain pucuk gantung, alternatif terjangkau yang tetap elegan.",
    material: "Perak 925",
    weight: "-",
    dimensions: "Ring size custom",
    features: [
      "Perak 925 berkualitas",
      "Desain pucuk gantung",
      "Harga terjangkau",
      "Hypoallergenic",
      "Cocok sehari-hari",
    ],
    story:
      "Versi perak dari Hanging Pucuk Ring, membawa keunikan desain dengan harga yang lebih accessible.",
  },
  {
    id: 23,
  ...
  // Brooches (Bros)
  {
    ...
    priceNumber: 0,
    category: "Bros",
    image: "/Danayu Brooch Gold/IMG_E7493.JPG",
    images: [
      "/Danayu Brooch Gold/IMG_E7493.JPG",
      "/Danayu Brooch Gold/IMG_E8695.JPG",
      "/Danayu Brooch Gold/IMG_1248.HEIC",
    ],
    description:
